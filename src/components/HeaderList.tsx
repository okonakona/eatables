        ...
        <div>
            <nav className="custom-shadow p-4">
                <ul className="flex justify-between">
                    <Link href="/" className="bg-[#E7F0F7] rounded-xl shadow-[0px_5px_7px_0px_rgba(0,0,0,0.25)] w-[75px] h-[75px] p-1.5">
                    ...
                    <Link href="/history/" className="bg-[#E7F0F7] rounded-xl shadow-[0px_5px_7px_0px_rgba(0,0,0,0.25)] w-[75px] h-[75px] p-1.5">
